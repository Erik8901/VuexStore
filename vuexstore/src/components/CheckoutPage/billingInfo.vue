  ...
  <div class="billing-page">
    ...
    <div class="billing-container">
      <div class="cart-container">
        <span class="products-in-cart-text"
          >Items in Cart: {{ this.amount.length }}</span
        >
        <span class="cart-tota-amount-text"
          >Total Cost: € {{ this.totalPrice }}</span
        >
        ...
        <div class="user-billing-info-container">
          <div class="input-fields-div">
            ...
            <div class="checkbox-container">
              ...
              <span class="subscribe-text"
                >Keep me up to date with news and special offers</span
              >
            </div>
          </div>
          <div class="user-personal-info-container">
            ...
            <div class="personal-info-fields">
              ...
              <div class="personal-info-fields-4">
                <input
                  class="input-info"
